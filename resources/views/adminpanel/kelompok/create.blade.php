						  ...
						  <div class="box-body">
								...
								<div class="form-group">
									 ...
									 <div class="col-xs-5">
										  ...
										  <div class=" col-xs-3 bootstrap-timepicker">
												<input type="text" name="awal_istirahat" class="absen_istirahat form-control timepicker">
										  </div>
										  <div class="col-xs-3 bootstrap-timepicker">
												<input type="text" name="akhir_istirahat" class="absen_istirahat form-control timepicker">
										  </div>
									 </div>
									 ...
									 <div class="col-xs-5">
										  <h5 class="col-xs-3 control-label"> Istirahat </h5>
										  <div class=" col-xs-3 bootstrap-timepicker">
												<input type="text" name="awal_istirahat_jumat" class="absen_istirahat form-control timepicker">
										  </div>
										  <div class="col-xs-3 bootstrap-timepicker">
												<input type="text" name="akhir_istirahat_jumat" class="absen_istirahat form-control timepicker">
										  </div>
									 </div>
								</div>
								...
								<div class="form-group">
									 ...
									 <div class="col-xs-5">
										  ...
										  <div class=" col-xs-3 bootstrap-timepicker">
												<input type="text" name="awal_masuk_istirahat" class="absen_masuk_istirahat form-control timepicker">
										  </div>
										  <div class="col-xs-3 bootstrap-timepicker">
												<input type="text" name="akhir_masuk_istirahat" class="absen_masuk_istirahat form-control timepicker">
										  </div>
									 </div>
								...
								<div class="form-group">
									 ...
									 <div class="col-xs-5">
										  ...
										  <div class=" col-xs-3 bootstrap-timepicker">
												<input type="text" name="awal_pulang" class="absen_pulang form-control timepicker">
										  </div>
										  <div class="col-xs-3 bootstrap-timepicker">
												<input type="text" name="akhir_pulang" class="absen_pulang form-control timepicker">
										  </div>
									 </div>
									 ...
									 <div class="col-xs-5">
										  <h5 class="col-xs-3 control-label"> Pulang </h5>
										  <div class=" col-xs-3 bootstrap-timepicker">
												<input type="text" name="awal_pulang_jumat" class="absen_pulang form-control timepicker">
										  </div>
										  <div class="col-xs-3 bootstrap-timepicker">
												<input type="text" name="akhir_pulang_jumat" class="absen_pulang form-control timepicker">
										  </div>
									 </div>
								</div>
